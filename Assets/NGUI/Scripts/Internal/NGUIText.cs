...
static public class NGUIText
{
	...
	static public bool ParseSymbol (string text, ref int index, BetterList<Color> colors, bool premultiply,ref bool isMineColor)
	{
	...
	static public void Print (Font font, string text, BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
	{
		...
		for (int i = 0; i < textLength; ++i)
		{
			...
			if (current.encoding && ParseSymbol(text, ref i, mColors, current.premultiply,ref isMineColor))
			{
