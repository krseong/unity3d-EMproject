...
- DEL: Removed the long-ago deprecated UISlicedSprite, UITiledSprite, and UISprite classes and some other legacy code.
...
- NEW: UISprite, best used for progress bars, sliders, etc (thanks nsxdavid).
